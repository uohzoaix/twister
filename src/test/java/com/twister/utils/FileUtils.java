...
public class FileUtils {
    ...
    /**
     * Util methods to write a defined number of random alphanumeric string (50 characters) in a file.
     * <p/>
     *
     * @param file          the file to write
     * @param numberOfLines the number of line to write in the file
     ...
     * @param file          the file to write
     * @param numberOfLines the number of line to write in the file
     * @param wait          delay to write a new line in file
     * @param timeUnit      the time unit
     * @return the list of lines written in the file
     * @throws IOException
     */
    public static List<String> writeRandomLines(File file, int numberOfLines, long wait, TimeUnit timeUnit) throws IOException {
