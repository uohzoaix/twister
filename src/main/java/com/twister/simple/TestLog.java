...
public class TestLog {
	...
	public static void testBytext() throws Exception {
		...
		System.out.println(alog2.toJsonString());
		System.out.println(alog2);
		AccessLogAnalysis alys = new AccessLogAnalysis(alog2.outKey(), alog2.getResponse_code(),
				alog2.getContent_length(), alog2.getRequest_time());
