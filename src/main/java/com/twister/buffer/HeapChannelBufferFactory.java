...
/**
 * A {@link ChannelBufferFactory} which merely allocates a heap buffer with the
 * specified capacity. {@link HeapChannelBufferFactory} should perform very well
 * in most situations because it relies on the JVM garbage collector, which is
 * highly optimized for heap allocation.
 */
