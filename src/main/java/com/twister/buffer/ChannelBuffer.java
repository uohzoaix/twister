 ...
 * href="http://en.wikipedia.org/wiki/Zero-based_numbering">zero-based
 ...
 * a value which meets a certain criteria. Complicated dynamic sequential search
 * can be done with {@link ChannelBufferIndexFinder} as well as simple static
 * single byte search.
 * <p>
 ...
 * buffer allocation and memory copy whenever possible, but there's no guarantee
 * that memory copy will not be involved.
 * 
 * <h4>Strings</h4>
 * 
...
public interface ChannelBuffer extends Comparable<ChannelBuffer> {
	 ...
	 * default {@link ByteOrder} are same with this buffer.
	 */
	...
	/**
	 * Returns the <a
	 * href="http://en.wikipedia.org/wiki/Endianness">endianness</a> of this
	 * buffer.
	 */
	ByteOrder order();
	 ...
	 *             {@code index + dst.writableBytes} is greater than
	 *             {@code this.capacity}
	 */
	 ...
	 * @throws IndexOutOfBoundsException
	 *             if the specified {@code index} is less than {@code 0} or if
	 *             {@code index + dst.remaining()} is greater than
	 *             {@code this.capacity}
	 */
	 ...
	 * @throws IndexOutOfBoundsException
	 *             if the specified {@code index} is less than {@code 0} or if
	 *             {@code index + src.remaining()} is greater than
	 *             {@code this.capacity}
	 */
	...
	/**
	 * @deprecated Use {@link #bytesBefore(ChannelBufferIndexFinder)} and
	 *             {@link #readBytes(int)} instead.
	 */
	@Deprecated
	 ...
	 * {@code true}. The search takes place from the specified {@code fromIndex}
	 * (inclusive) to the specified {@code toIndex} (exclusive).
	 * <p>
	 * If {@code fromIndex} is greater than {@code toIndex}, the search is
	 * performed in a reversed order.
	 ...
	 *         returned {@code true}. {@code -1} if the {@code indexFinder} did
	 *         not return {@code true} at all.
	 */
	 ...
	 * 
	 * @return the number of bytes between the current {@code readerIndex} and
	 *         the first place where the {@code indexFinder} returned
	 ...
	 * 
	 * @return the number of bytes between the specified {@code index} and the
	 *         first place where the {@code indexFinder} returned {@code true}.
	 *         {@code -1} if the {@code indexFinder} did not return {@code true}
	 *         at all.
	 * 
	 * @throws IndexOutOfBoundsException
	 *             if {@code index + length} is greater than
	 ...
	 * identical to {@code buf.slice(0, buf.capacity())}. This method does not
	 * modify {@code readerIndex} or {@code writerIndex} of this buffer.
	 */
	...
	/**
	 * Converts this buffer's readable bytes into an array of NIO buffers. The
	 * returned buffers might or might not share the content with this buffer,
	 * while they have separate indexes and marks. This method is identical to
	 * {@code buf.toByteBuffers(buf.readerIndex(), buf.readableBytes())}. This
	 * method does not modify {@code readerIndex} or {@code writerIndex} of this
	 * buffer.
	 */
	...
	/**
	 * Converts this buffer's sub-region into an array of NIO buffers. The
	 * returned buffers might or might not share the content with this buffer,
	 * while they have separate indexes and marks. This method does not modify
	 * {@code readerIndex} or {@code writerIndex} of this buffer.
	 */
	...
	/**
	 * @deprecated Use {@link #bytesBefore(int, int, ChannelBufferIndexFinder)}
	 *             and {@link #toString(int, int, Charset)} instead.
	 */
	@Deprecated
