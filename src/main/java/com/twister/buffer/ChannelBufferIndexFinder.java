 ...
 * complex and dynamic condition than just a simple value matching. Please refer
 * to {@link ChannelBuffer#indexOf(int, int, ChannelBufferIndexFinder)} and
 * {@link ChannelBuffer#bytesBefore(int, int, ChannelBufferIndexFinder)} for
 * more explanation.
 * 
...
public interface ChannelBufferIndexFinder {
	 ...
	 * exception such as {@link IndexOutOfBoundsException} nor perform an
	 * operation which modifies the content of the buffer.
	 */
	...
	/**
	 * Index finder which locates a linear whitespace ({@code ' '} and
	 * {@code '\t'}).
	 */
