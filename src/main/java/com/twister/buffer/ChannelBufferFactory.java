...
public interface ChannelBufferFactory {
	...
	/**
	 * Returns a {@link ChannelBuffer} with the specified {@code capacity}. This
	 * method is identical to {@code getBuffer(getDefaultOrder(), capacity)}.
	 * 
	 * @param capacity
	 *            the capacity of the returned {@link ChannelBuffer}
	...
	/**
	 * Returns a {@link ChannelBuffer} with the specified {@code endianness} and
	 * {@code capacity}.
	 * 
	 * @param endianness
	 *            the endianness of the returned {@link ChannelBuffer}
	 * @param capacity
	 *            the capacity of the returned {@link ChannelBuffer}
	 * @return a {@link ChannelBuffer} with the specified {@code endianness} and
	 *         {@code capacity}, whose {@code readerIndex} and
	 ...
	 * the {@code array}. This method is identical to
	 * {@code getBuffer(getDefaultOrder(), array, offset, length)}.
	 * 
	 * @param array
	 *            the byte array
	 * @param offset
	 ...
	 * 
	 * @return a {@link ChannelBuffer} with the specified content, whose
	 *         {@code readerIndex} and {@code writerIndex} are {@code 0} and
	 *         {@code (length - offset)} respectively
	 */
	 ...
	 * 
	 * @param nioBuffer
	 *            the NIO {@link ByteBuffer}
	 * 
	 * @return a {@link ChannelBuffer} with the specified content, whose
	 *         {@code readerIndex} and {@code writerIndex} are {@code 0} and
	 *         {@code nioBuffer.remaining()} respectively
	 */
